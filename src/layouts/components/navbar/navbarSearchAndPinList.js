...
export default {
  pages: {
    ...
    data: [
      ...
      // UI ELEMENTS
      {title: "Classe",                    url: "/samaecole/Gestion/classes/classe",           icon: "ListIcon",           is_bookmarked: false},
      {title: "Niveau",                    url: "/samaecole/Gestion/niveaux/niveau",   icon: "ImageIcon",          is_bookmarked: false},
      {title: "Annee Scolaire",            url: "/samaecole/Gestion/AnneeScolaire/anneescolaire",            icon: "LayoutIcon",         is_bookmarked: false},
      {title: "eleve",                     url: "/samaecole/RH/eleves/eleve",          icon: "LayoutIcon",         is_bookmarked: false},
      {title: "Enseignant",                url: "/samaecole/RH/Enseignant/enseignant",                 icon: "DropletIcon",        is_bookmarked: false},
      {title: "Parent",                    url: "/samaecole/RH/Parents/parent",             icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Emploi du Temps",           url: "/samaecole/Gestion/EmploiDuTemps/emploi_du_temps",        icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Gestion Notes",             url: "/samaecole/Gestion/Evaluations/evaluation",         icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Evaluation",                url: "/samaecole/Gestion/Evaluations/evaluation",      icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Matiere",                   url: "/samaecole/Gestion/Matieres/matiere",        is_bookmarked: false},
